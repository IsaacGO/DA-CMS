...
namespace ControlApp.DataAccess
{
    ...
    partial void DeleteTBL_USER(TBL_USER instance);
		...
		{
			IExecuteResult result = this.ExecuteMethodCall(this, ((MethodInfo)(MethodInfo.GetCurrentMethod())), p_ACTION, pID_BY, pID_NOTE, pNOTE_TITLE, pNOTE_DATE, pNOTE_CONTENT);
